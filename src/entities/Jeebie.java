/**
 * Jeebie --- a class that represents a species of Martian animal entities in the Mars habitat that can move around the habitat,
...
public class Jeebie extends MartianAnimal implements Movable, Collidable, Attackable,Feedable {
    ...
    //constructor
    /**
     * Create Jeebie, a Martian animal species with its previous and current coordinate,map boundary information and collision flag
     * @param x x-coordinate
     * @param y y-coordinate
     * @param mapWidth map boundary
     * @param mapHeight map boundary
     */
    public Jeebie(int x, int y, int mapWidth, int mapHeight) {
    ...
    /**
     * Print Jeebie coordinate in habitat
     * @return Jeebie information in string
     */
    @Override
    public String toString() {
        return "JEEBIE at position (" + getY() + ", " + getX() + ")";
    }
    ...
    /**
     * Handles the movement of the Jeebie by updating its previous and current position
     * @param newX target x-coordinate
     * @param newY target y-coordinate
    ...
    private void handleMovement(int newX, int newY, MarsHabitat habitat, HabitabilityMeter meter) {
        ...
        if (entityAtNewPosition instanceof Dog){
            return;
        }
        prevX = x;
        prevY = y;
    ...
    /**
     * Moves the Jeebie north by decreasing its x-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie south by decreasing its y-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie east by increasing its x-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie west by decreasing its x-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie north-east by increasing its x-coordinate and decreasing its y-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie north-west by decreasing its x-coordinate and decreasing its y-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie north-east by increasing its x-coordinate and increasing its y-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Moves the Jeebie north-east by decreasing its x-coordinate and increasing its y-coordinate by the step size
     * @param habitat reference to the MarsHabitat object
     * @param meter reference to the HabitabilityMeter object
     */
    @Override
    ...
    /**
     * Handles collision logic when this Jeebie collides with another entity.
     *
    ...
    /**
     * Handles the interaction when Jeebie collides with Cattle.
     *
    ...
    /**
     * Handles the interaction when Jeebie collides with Vegetation.
     *
    ...
    /**
     * Handles the combat when Jeebie collides with Dog
    ...
    private void handleDogInteraction(Dog dog, MarsHabitat habitat,HabitabilityMeter meter) {
        ...
        while(health >= MIN_HEALTH && dog.getHealth() >= MIN_HEALTH){
            if (health <= MIN_HEALTH){
                ...
                habitat.removeOnMap(this.x,this.y);
                meter.increaseHabitabilityEvent(this);
                break;
            }
            if (dog.getHealth() <= MIN_HEALTH){
                System.out.println("Dog died");
                habitat.removeOnMap(dog.getX(),dog.getY());
                meter.decreaseHabitabilityEvent(dog);
                break;
            }
